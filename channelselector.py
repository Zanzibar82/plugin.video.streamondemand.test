...
def getmainlist(preferred_thumb=""):
    ...
    itemlist.append( Item(title="Oggi in TV" , channel="filmontv" , action="mainlist" , thumbnail = "http://i.imgur.com/CbMBACl.png") )
...
def channels_list():
    ...
    itemlist.append( Item( title="[COLOR azure]Cucinarefacile[/COLOR]"        , channel="cucinarefacile"       , language="IT"    , category="D"       , type="generic"     ,thumbnail="http://www.cucinarefacile.com/wp-content/themes/food-recipes/images/logo.png"))
